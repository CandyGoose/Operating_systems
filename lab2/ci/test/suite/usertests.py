...
QUICK_TESTS = [
    ...
    Xv6UserTest(name="twochildren", timeout=timedelta(seconds=20)),
    Xv6UserTest(name="forkfork", timeout=timedelta(seconds=3)),
    Xv6UserTest(name="forkforkfork", timeout=timedelta(seconds=300)),
    Xv6UserTest(name="reparent2", timeout=timedelta(seconds=30)),
    Xv6UserTest(name="mem", timeout=timedelta(seconds=10)),
    Xv6UserTest(name="sharedfd", timeout=timedelta(seconds=40)),
    Xv6UserTest(name="fourfiles", timeout=timedelta(seconds=10)),
    Xv6UserTest(name="createdelete", timeout=timedelta(seconds=50)),
    Xv6UserTest(name="unlinkread", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="linktest", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="concreate", timeout=timedelta(seconds=90)),
    Xv6UserTest(name="linkunlink", timeout=timedelta(seconds=20)),
    Xv6UserTest(name="subdir", timeout=timedelta(seconds=6)),
    Xv6UserTest(name="bigwrite", timeout=timedelta(seconds=50)),
    Xv6UserTest(name="bigfile", timeout=timedelta(seconds=6)),
    Xv6UserTest(name="fourteen", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="rmdot", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="dirfile", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="iref", timeout=timedelta(seconds=20)),
    Xv6UserTest(name="forktest", timeout=timedelta(seconds=30)),
    Xv6UserTest(name="sbrkbasic", timeout=timedelta(seconds=50)),
    Xv6UserTest(name="sbrkmuch", timeout=timedelta(seconds=40)),
    Xv6UserTest(
        name="kernmem",
        timeout=timedelta(milliseconds=500),
    ...
    Xv6UserTest(name="sbrkarg", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="validatetest", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="bsstest", timeout=timedelta(seconds=4)),
    Xv6UserTest(name="bigargtest", timeout=timedelta(seconds=4)),
